<%@ Page Language="C#" AutoEventWireup="true" CodeFile="setupguestbook.aspx.cs" Inherits="admin_setupguestbook" %>
...
<div id="containner">
	<div id="header">所有的留言信息</div>
	<div id="content">
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            AutoGenerateColumns="False" DataKeyNames="messageID" DataSourceID="AccessDataSource1" EmptyDataText="<b style='color:#fff;margin-left:220px;'>暂无留言</b>">
            <Columns>
        ...
        <asp:AccessDataSource ID="AccessDataSource1" runat="server" ConflictDetection="CompareAllValues"
            ...
            OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [message] where [toUerID]='guestbook' ORDER BY [ifNew] DESC, [sendTime] DESC"
