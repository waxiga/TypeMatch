...
if(!x_open_path)
	var x_open_path = 'images/theme/white/';
...
win_frame += "<img src='" + help_img + "' width='12' height='21' border='0' onclick='xopen_about()' title='关于本窗口' />";
...
function xopen_about(){
	str = "蓝梦家园(http://cbf6.xinwen365.com)版权所有";
	alert(str);
}
function xopen_back(){
